...
public class ResearchNonHecServiceImpl implements ResearchNonHecService {
    ...
    @Override
    public List<ResearchNonHecDTO> getResourceDTO(List<ResearchNonHec> classObjectList){
        return classObjectList.stream().map(x->new ResearchNonHecDTO(x)).collect(Collectors.toList());
    }

    @Override
    public List<ResearchNonHec> getResourceForRole(Integer oricSessionId, Integer campusId, String role){
